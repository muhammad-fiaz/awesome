...
export function Popup() {
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-100 bg-black/60 backdrop-blur-sm animate-none"
        onClick={handleClose}
      />
      <div
        className="fixed z-101 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-lg font-sans animate-none"
      >
